            ...
            <form action="formulario_res.php" method="POST" enctype="multipart/form-data">
                <div class="form-box">
                    <div class="input-wrap">
                        ...
                        <!--******************************** Programa ********************************-->
                        <input type="text" name="programa" placeholder="Programa academico al que pertenece">

                        <!--******************************** Grupo de investigacion ********************************-->
                        <input type="text" name="grupo_inv" placeholder="Grupo de Investigación al que pertenece">

                        <!--******************************** Instituto ********************************-->
                        <input type="text" name="institu" placeholder="Nombre de la institución a la que pertenece">

                        <!--******************************** Ubicacion ********************************-->
                        <input type="text" name="ubicacion" placeholder="Nombre de la ubicación a la que pertenece">

                        <!-- Campo para subir el archivo PDF -->
                        <label for="archivo_pdf" class="pon">Subir archivo WORD de la ponencia:</label>
                        <input type="file" name="archivo_pdf" id="archivo_pdf" accept=".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" required>
